...
import threading
class VideoStream():
    def __init__(self,socket_name=None,stream_node="accepter",peering_name=None,cam_url=None,RECVED_MAX_BYTES=65472,title=None):
        self.title=title
